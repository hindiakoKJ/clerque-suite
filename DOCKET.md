...
| **Notification producers** | Schema + bell + dropdown shipped, but no cron jobs are creating notifications yet. Need: low-stock check on inventory adjust, AR/AP overdue daily scan, period-close reminder (5 days before month-end), SOD-override audit hook |
