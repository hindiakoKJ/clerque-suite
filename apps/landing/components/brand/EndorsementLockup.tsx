    ...
    <div className="flex flex-col overflow-hidden rounded-xl border border-ink/10 bg-paper">
      ...
      <div className="flex flex-col gap-3 px-9 py-8">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[32px] font-semibold tracking-wordmark-tight text-ink leading-none">
            {productName}
          </span>
        </div>
        <div className="flex items-center gap-2 pl-14">
          <span className="text-[10px] font-medium uppercase tracking-[0.14em] text-ink/45">by</span>
          <ParentMark size={16} className="text-hns-600" />
          <span className="text-[13px] font-semibold tracking-tight text-ink/60">HNScorpPH</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3.5 bg-ink px-9 py-4">
        ...
        <span className="text-lg font-semibold tracking-wordmark-tight text-paper leading-none">
          {productName}
        </span>
